                ...
                <form action="modul/pemasok/proses.php?aksi=tambah" method="post">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="namepemasok"placeholder="Masukkan nama pemasok" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="alamat">Alamat</label>
                        <input clas="form-control" type="text" name="alamat" placeholder="Masukkan alamat"required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="telepon">Telepon</label>
                        <input clas="form-control" type="text" name="telepon" placeholder="Masukkan telepon"required>
                    </div>
                    <div class="mb-3">
                    ...
                    <form action="modul/pemasok/proses.php?aksi=edit&id=<?=$row_pemasok['id_pemasok'];?>"method="post">
                        ...
                        <div class="mb-3">  
                            ...
                            <select class="form-select" name="status">
                                ...
                                <option value="0" <?= $row_pemasok['status']==1?'selected':'';?>>Tidak Aktif</option>
                            </select>
                          </div>
                            </div>
                            <div class="modal-folder">
